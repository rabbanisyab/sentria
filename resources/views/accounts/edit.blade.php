                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="w-11 h-11 sm:w-12 sm:h-12 shrink-0 rounded-2xl
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path stroke-linecap="round"
                                  stroke-linejoin="round"
                                  d="m15.5 13.5 2.5-2.5 2 2-2.5 2.5-2.5.5.5-2.5Z" />
                        </svg>
                    </div>
            ...
            <div class="relative bg-white rounded-2xl shadow-sm
                ...
                <div class="p-5 sm:p-7">
                    <form action="{{ route('accounts.update', $account->id) }}" method="POST">
                        ...
                        <div class="mb-5">
                            <label for="name"
                                   class="block text-sm font-semibold text-[#1D3557] mb-2">
                                Account Name
                            </label>
                            ...
                            <div class="relative">
                                <select id="type"
                                        ...
                                        class="w-full appearance-none rounded-xl
                                               ...
                                               px-4 py-3 pr-10 text-sm text-gray-800
                                               focus:border-[#457B9D]
                                               focus:ring-2 focus:ring-[#457B9D]/20
                                               focus:outline-none transition">
                                    ...
                                    <option value="ewallet"
                                        {{ old('type', $account->type) == 'ewallet' ? 'selected' : '' }}>
                                        E-Wallet
                                    </option>
                                    ...
                                    <option value="electronic_card"
                                        {{ old('type', $account->type) == 'electronic_card' ? 'selected' : '' }}>
                                        Electronic Card
                                    </option>
                                </select>
