<x-app-layout>
    ...
    <div class="min-h-screen bg-[#F7F9FC] pb-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8">
            ...
            {{-- SUCCESS MESSAGE --}}
            @if(session('success'))
                <div class="mb-5 rounded-2xl border border-green-100
                ...
                <div class="flex items-start justify-between gap-3">
                    ...
                    <a href="{{ route('accounts.create') }}"
                       class="shrink-0 inline-flex items-center justify-center
                              gap-1.5 px-4 py-2.5 rounded-xl
                              bg-[#457B9D] text-white text-sm font-semibold
                              shadow-sm hover:bg-[#386B89] transition">
                                ...
                                @foreach($categoryAccounts as $account)
                                    ...
                                    <div class="px-4 sm:px-5 py-4 flex items-center gap-3
                                        ...
                                        <div class="text-right shrink-0">
                                            ...
                                            <p class="text-sm sm:text-base font-bold text-[#1D3557]">
                                        ...
                                        <div class="flex items-center gap-0.5 shrink-0">
                                            ...
                                            <a href="{{ route('accounts.edit', $account->id) }}"
                                               class="w-8 h-8 rounded-lg flex items-center justify-center
                                                      text-gray-400 hover:text-[#457B9D]
                                                      hover:bg-[#EAF2F6] transition"
                                               title="Edit account">
