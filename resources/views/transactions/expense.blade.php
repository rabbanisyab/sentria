    ...
    <div class="py-5 sm:py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="{{ route('transactions.index') }}"
               class="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-red-500 transition mb-5">
            ...
            <div class="mb-6 sm:mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Add Expense</h1>
                        <p class="text-sm text-gray-500 mt-1">Record money going out of your account.</p>
                    </div>
                    ...
                    <form method="POST"
                        ...
                        <div>
                            ...
                            <select id="account_id" name="account_id" required
                                    class="w-full rounded-xl border-gray-200 bg-gray-50
                                           focus:border-red-500 focus:ring-red-500 text-gray-700 py-3">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                      ...
                                      class="w-full rounded-xl border-gray-200 bg-gray-50
                                             focus:border-red-500 focus:ring-red-500
                                             text-gray-700 py-3">{{ old('description') }}</textarea>
                        ...
                        {{-- Submit --}}
                        <button type="submit"
                                class="w-full mt-2 py-3.5 rounded-xl bg-red-500 hover:bg-red-600
