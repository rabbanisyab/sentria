    ...
    <div class="py-5 sm:py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="{{ route('transactions.index') }}"
               class="inline-flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-[#457B9D] transition mb-5">
            ...
            <div class="mb-6 sm:mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div class="w-12 h-12 sm:w-14 sm:h-14 shrink-0 rounded-2xl
                                bg-green-50 text-green-600 flex items-center justify-center">
                    ...
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Add Income</h1>
                        <p class="text-sm text-gray-500 mt-1">Record money coming into your account.</p>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-green-100 overflow-hidden">
                ...
                <div class="p-5 sm:p-7">
                    ...
                    <form method="POST"
                        ...
                        <div>
                            ...
                            <select id="account_id" name="account_id" required
                                    class="w-full rounded-xl border-gray-200 bg-gray-50
                                           focus:border-green-500 focus:ring-green-500 text-gray-700 py-3">
                        ...
                        {{-- Submit --}}
                        <button type="submit"
                                class="w-full mt-2 py-3.5 rounded-xl bg-green-500 hover:bg-green-600
