...
<div class="py-6">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-sm p-6">
            <form action="{{ route('transactions.store.transfer') }}" method="POST">
                @csrf
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">
                        From Account
                    </label>
                    <select name="from_account_id" class="mt-1 w-full rounded-lg border-gray-300">
                    <option value="">
                        Choose Account
                    </option>
                ...
                <div class="mb-4">
                    ...
                    <select name="to_account_id" class="mt-1 w-full rounded-lg border-gray-300">
                    <option value="">
                        Choose Account
                    </option>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="admin_fee" class="mt-1 w-full rounded-lg border-gray-300" placeholder="0">
                </div>
